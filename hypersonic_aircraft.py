...
def output():
        out_path = './hypersonic_aircraft/'
        if not os.path.exists(out_path):
            os.makedirs(out_path)
        print('************Start to Output************')
        # output the 'bottom' geometry 
        bottom.output_tecplot(fname=f'{out_path}/bottom.dat', one_piece=False)
        bottom.output_plot3d(fname=f'{out_path}/bottom.xyz')
        plot3d_to_igs(fname=f'{out_path}/bottom')
        # Output the 'connect' geometry
        connect.output_tecplot(fname=f'{out_path}/connect.dat', one_piece=False)
        connect.output_plot3d(fname=f'{out_path}/connect.xyz')
        plot3d_to_igs(fname=f'{out_path}/connect')
        # output the 'support' geometry
        support.output_tecplot(fname=f'{out_path}/support.dat')
        support.output_plot3d(fname=f'{out_path}/support.xyz')
        plot3d_to_igs(fname=f'{out_path}/support')
        # output the 'forebody' geometry
        forebody.output_tecplot(fname=f'{out_path}/forebody.dat')
        forebody.output_plot3d(fname=f'{out_path}/forebody.xyz')
        plot3d_to_igs(fname=f'{out_path}/forebody')
        # output the 'body1' geometry
        body1.output_tecplot(fname=f'{out_path}/body1.dat')
        body1.output_plot3d(fname=f'{out_path}/body1.xyz')
        plot3d_to_igs(fname=f'{out_path}/body1')
        # output the 'uppersurf' geometry
        uppersurf.output_tecplot(fname=f'{out_path}/uppersurf.dat')
        uppersurf.output_plot3d(fname=f'{out_path}/uppersurf.xyz')
        plot3d_to_igs(fname=f'{out_path}/uppersurf')
        # output the 'lowersurf' geometry
        lowersurf.output_tecplot(fname=f'{out_path}/lowersurf.dat')
        lowersurf.output_plot3d(fname=f'{out_path}/lowersurf.xyz')
        plot3d_to_igs(fname=f'{out_path}/lowersurf')
        # output the 'ending_upper' geometry
        ending_upper.output_tecplot(fname=f'{out_path}/ending_upper.dat')
        ending_upper.output_plot3d(fname=f'{out_path}/ending_upper.xyz')
        plot3d_to_igs(fname=f'{out_path}/ending_upper')
        # output the 'ending_lower' geometry
        ending_lower.output_tecplot(fname=f'{out_path}/ending_lower.dat')
        ending_lower.output_plot3d(fname=f'{out_path}/ending_lower.xyz')
        plot3d_to_igs(fname=f'{out_path}/ending_lower')
        # output the 'side' geometry
        side.output_tecplot(fname=f'{out_path}/side.dat')
        side.output_plot3d(fname=f'{out_path}/side.xyz')
        plot3d_to_igs(fname=f'{out_path}/side')
