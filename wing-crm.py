...
if __name__ == "__main__":
    ...
    wing.output_tecplot(fname=os.path.join(out_path, 'Wing-CRM.dat'), one_piece=False, split=True)

    wing.output_guide_curve(os.path.join(out_path, 'Wing-CRM-guide-curve.dat'))
